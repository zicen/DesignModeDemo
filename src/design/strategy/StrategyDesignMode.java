...
/**
 * 一、策略模式（design.strategy.Strategy）:它定义了算法家族，分别封装起来，让它们之间可以互相替换，此模式让算法的变化不会影响到使用算法的客户。
 * 1、第一步先定义一个算法抽象类
 * 2、第二步创建三个实现类
...
class ConcreteStrategyA extends Strategy {
    ...
    public void algorithmInterface() {
        System.out.println("design.strategy.ConcreteStrategyA");
    }
}
...
class ConcreteStrategyB extends Strategy {
    ...
    @Override
    public void algorithmInterface() {
        System.out.println("design.strategy.ConcreteStrategyB");
    }
}
...
class ConcreteStrategyC extends Strategy {
    ...
    @Override
    public void algorithmInterface() {
        System.out.println("design.strategy.ConcreteStrategyC");
    }
}
